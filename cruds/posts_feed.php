...
$comando = $con->prepare("select postagens.cod_post, perfil.cod_imagem, perfil.apelido from perfil inner join postagens on postagens.cod_perfil = perfil.cod_perfil where postagens.cod_perfil = (select seguidores.cod_doSeguido from seguidores where seguidores.cod_perfil = ?) order by postagens.hora_post desc");
