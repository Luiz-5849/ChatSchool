...
<head>
    ...
    <title>Adm - Programador</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand h1-text">Programador</a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <li><a class="dropdown-item" href="novo_perfil.php">Novo coordenador</a></li>
                      <li><a class="dropdown-item" href="consulta.php">Consulta</a></li>
                      <li><a class="dropdown-item" href="nova_escola.html">Nova Escola</a></li>
                    </ul>
                  </li>
                  <!--<li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
