...
<head>
    ...
    <title>Adm - Coordenação</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="">Coordenação</a>
          <a class="button" href="../login.html">Sair</a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <li><a class="dropdown-item" href="novo_perfil_co.php">Criar Perfis</a></li>
                      <li><a class="dropdown-item" href="">Consulta</a></li>
                      <li><a class="dropdown-item" href="comunicados_co.html">Comunicar</a></li>
                      <li><a class="dropdown-item" href="nova_turma.php">Nova turma</a></li>
                      <li><a class="dropdown-item" href="novo_curso.html">Novo curso</a></li>
                    </ul>
                  </li>
                  <!--<li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
